  ...
  public: {
    Tables: {
      ...
      tip_connections: {
        ...
        Relationships: [
          {
            foreignKeyName: "tip_connections_source_tip_id_fkey"
          ...
          {
            foreignKeyName: "tip_connections_target_tip_id_fkey"
            columns: ["target_tip_id"]
            isOneToOne: false
            referencedRelation: "tips"
            referencedColumns: ["id"]
          },
      ...
      tips: {
        ...
        Relationships: [
          {
            foreignKeyName: "tips_original_tip_id_fkey"
